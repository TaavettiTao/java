...
public class RSATest {   
    ...
    public static void main(String[] args) {   
        try {   
            ...
            //私钥
            //模
            System.out.println("privateKey.modulus:"+privateKey.getModulus().toString());
            //指数
            System.out.println("privateKey.exponent:"+privateKey.getPrivateExponent().toString());
            
            //公钥
            //模
            System.out.println("publicKey.modulus:"+publicKey.getModulus().toString());
            //指数
            System.out.println("publicKey.exponent:"+publicKey.getPublicExponent().toString());
            
  
            byte[] e = encrypt.encrypt(publicKey, encryptText.getBytes());   
            byte[] de = encrypt.decrypt(privateKey, e);   
            /*System.out.println(toHexString(e));*/ 
            System.out.println("加密数据："+toHexString(de));
     ...
     */  
    public Key loadKey(String filename, int type) throws NoSuchAlgorithmException,   
